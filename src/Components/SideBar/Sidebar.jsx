    ...
    return (
        <div>
            ...
            <div className="sidebar">
                <div className='toggle_button d-block d-xl-none me-3' onClick={() => ToggleBtn()}>
                ...
                <div className="menulist">
                    ...
                    <Nav className="d-block" navbarScroll>
                        <Nav.Link onClick={() => onhidesidebar()} as={NavLink} exact='' to="/"><i className="fa-solid fa-border-all"></i> Dashboard</Nav.Link>
                        <Nav.Link onClick={() => onhidesidebar()} as={NavLink} exact='' to="/display-pages"><i className="fa-solid fa-user"></i>Display Pages</Nav.Link>
                        ...
                        <Nav.Link onClick={() => onhidesidebar()} as={NavLink} exact='' to="/login"><i className="fa-solid fa-arrow-right-from-bracket"></i> Log Out</Nav.Link>
                    </Nav>
                </div>
            </div>
        </div>
